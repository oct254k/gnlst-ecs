...
│ 일정 │ ─────────────────────────────────────────────────────────────── │ │
│ ▸대시│ ┌─월──┬─화──┬─수──┬─목──┬─금──┬─토──┬─일──┐                      │ 임원 색상 레이어 │
│ ▸달력│ │ 28  │ 29  │ 30  │ 1   │ 2   │ 3   │ 4(빨)│ ← 일요일 빨강       │ [TOGGLE]         │
│ ▸리스│ │     │     │     │ [CAL│ [CAL│     │     │                      │ ● 박전무 ✅      │
│ ▸레이│ │     │     │     │-EVT │-EVT │     │     │                      │ ● 이상무 ✅      │
│ 데이 │ ├─────┼─────┼─────┼─────┼─────┼─────┼─────┤                      │ ● 김전무 ✅      │
...
```
[CAL-HEADER: ◀ 오늘 ▶  2026.05.11~17  [CAL-VIEWSWITCH: 월/●주/일]]
────────────────────────────────────────────────────────────────────
       │ 월 11 │ 화 12 │ 수 13 │ 목 14[오늘]│ 금 15(빨)│ 토 16 │ 일 17(빨)│
